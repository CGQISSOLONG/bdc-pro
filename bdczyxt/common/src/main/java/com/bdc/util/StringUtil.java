...
public class StringUtil {
	...
	public static String clearScript(String str) {
		...
		pstr += "style=\"CURSOR: pointer\" onmousewheel=\"return bbimg\\(this\\)\" ";
	...
	public static String replaceScript(String content, String regex, String replacement) {
	 ...
	 * <p/>
	 * In Jive, every time a user logs in, we simply take their plain text password, compute the
	...
	/**
	 * Hashes a String using the specified algorithm and returns the result as a String of
	 * hexadecimal numbers. This method is synchronized to avoid excessive MessageDigest object
	 * creation. If calling this method becomes a bottleneck in your code, you may wish to maintain
	 * a pool of MessageDigest objects instead of using this method.
	 * <p/>
	 * A hash is a one-way function -- that is, given an input, an output is easily computed.
	 * However, given the output, the input is almost impossible to compute. This is useful for
	 * passwords since we can store the hash and a hacker will then have a very hard time
	...
	/**
	 * Hashes a byte array using the specified algorithm and returns the result as a String of
	 * hexadecimal numbers. This method is synchronized to avoid excessive MessageDigest object
	 * creation. If calling this method becomes a bottleneck in your code, you may wish to maintain
	 * a pool of MessageDigest objects instead of using this method.
	 * <p/>
		...
		synchronized (algorithm.intern()) {
			...
			if (digest == null) {
				try {
					...
					System.err.println("Failed to load the " + algorithm + " MessageDigest. " + "Jive will be unable to function normally." + nsae);
					return null;
				}
			}
			// Now, compute hash.
	...
	/**
	 * 
	 * @Title: includeString @Description: 判断orignStr中是否含有key @param @param orignStr @param @param
	 * key @param @return @return Boolean @author baizongwei @throws
	 */
